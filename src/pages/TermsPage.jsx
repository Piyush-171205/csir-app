      ...
      <div className="page-content">
        ...
        <div className="auth-card large">
          ...
          <div className="info-content">
            <p><strong>Acceptance of Terms:</strong> {t.termsContent1}</p>
            <p><strong>User Accounts:</strong> {t.termsContent2}</p>
            <p><strong>User Responsibilities:</strong> {t.termsContent3}</p>
            <p><strong>Prohibited Activities:</strong> {t.termsContent4}</p>
            <p><strong>Modifications:</strong> {t.termsContent5}</p>
          </div>
